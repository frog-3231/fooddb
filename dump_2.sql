...
INSERT INTO `administrator` VALUES ('ADM-2CB6FECC','venz_admin','0a6b4567f2f9b40014f80936fc1e1898a1a1da1f0f8ad4de3cafd77a3ea118c6','venz@fooddb.com','2026-04-15 18:29:16'),('ADM-875F1D58','alvin_admin','6ee9dbbcb9ec1a87efea06976b3776ba9610ebe2cca0d2b3045e04156148b943','alvin@fooddb.com','2026-04-05 03:19:19');
...
CREATE TABLE `orders` (
  ...
  `payment` enum('cash','cancelled') NOT NULL DEFAULT 'cash',
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_order_update` BEFORE UPDATE ON `orders` FOR EACH ROW BEGIN
    ...
    IF OLD.status IN ('Ready for Delivery','Completed', 'Cancelled') THEN
        SIGNAL SQLSTATE '45000' 
        SET MESSAGE_TEXT = 'Locked: Order is already done.';
    END IF;
...
INSERT INTO `users` VALUES ('USR-114EC0C3',NULL,'CSH-9EA39641',NULL,NULL,'Active'),('USR-14FCC627','CST-BBF89E0F',NULL,NULL,NULL,'Active'),('USR-863FBB0A',NULL,NULL,'RDR-9F62B298',NULL,'Active'),('USR-ADC5C583',NULL,NULL,NULL,'ADM-2CB6FECC','Active'),('USR-D17EB70B',NULL,NULL,NULL,'ADM-875F1D58','Active');
...
--
/*!50003 DROP PROCEDURE IF EXISTS `sp_create_admin_automated` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_create_admin_automated`(
    IN p_username VARCHAR(255),
    IN p_password_plain VARCHAR(255),
    IN p_email VARCHAR(255)
)
BEGIN
    -- 1. Create the MySQL System User (The login for the DB)
    -- We use the plain text password here for the account creation
    SET @create_sql = CONCAT('CREATE USER "', p_username, '"@"localhost" IDENTIFIED BY "', p_password_plain, '"');
    PREPARE stmt FROM @create_sql;
    EXECUTE stmt;
    DEALLOCATE PREPARE stmt;

    -- 2. Insert into your table with AUTOMATIC HASHING
    -- SHA2(string, 256) creates exactly 64 characters, satisfying your CHECK constraint
    ...
    -- 3. Grant Permissions
    SET @grant_sql = CONCAT('GRANT SELECT, INSERT, UPDATE ON fooddb.* TO "', p_username, '"@"localhost"');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_create_cashier` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_create_cashier`(
...
BEGIN
    -- 1. Create MySQL Login
    SET @sql = CONCAT('CREATE USER "', p_username, '"@"localhost" IDENTIFIED BY "', p_password_plain, '"');
    PREPARE stmt FROM @sql;
    EXECUTE stmt;
    DEALLOCATE PREPARE stmt;

    -- 2. Insert into Cashier Table
    INSERT INTO cashier (username, password, email, phone)
    VALUES (p_username, SHA2(p_password_plain, 256), p_email, p_phone);

    -- 3. Permissions (Optional: adjust as needed)
    SET @grant = CONCAT('GRANT SELECT, INSERT ON fooddb.* TO "', p_username, '"@"localhost"');
    PREPARE gstmt FROM @grant;
    EXECUTE gstmt;
    DEALLOCATE PREPARE gstmt;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    INSERT INTO customer (username, password, email, phone, first_name, last_name)
    VALUES (p_username, SHA2(p_password_plain, 256), p_email, p_phone, p_first_name, p_last_name);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_create_delivery_rider` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_create_delivery_rider`(
    IN p_username VARCHAR(50),
    IN p_password_plain VARCHAR(255),
    IN p_email VARCHAR(100),
    IN p_phone VARCHAR(11),
...
BEGIN
    ...
    INSERT INTO delivery_rider (username, password, email, phone, first_name, last_name)
    VALUES (p_username, SHA2(p_password_plain, 256), p_email, p_phone, p_first_name, p_last_name);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2026-04-16  2:34:19
